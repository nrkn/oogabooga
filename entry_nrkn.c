...
int entry(int argc, char **argv) {
	...
	window.scaled_width = 640; // We need to set the scaled size if we want to handle system scaling (DPI)
	window.scaled_height = 360; 
	window.x = 200;
	window.y = 90;
	window.clear_color = hex_to_rgba(0x3399ffff);
